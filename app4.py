...
mu = np.mean(returns_train, axis=0).values  # Cálculo de rendimientos medios
S = returns_train.cov().values  # Cálculo manual de la matriz de covarianza
...
dist = squareform(1 - corr_matrix)  # Convierte la matriz de correlaciones en distancias
Z = linkage(dist, 'ward')
